...
if redis:get('TIME:CHECK'..msg.to.id) then
  TIME_CHECK = redis:get('TIME:CHECK'..msg.to.id)
end
  -- Ignore service msg
  if msg.service then
    return msg
    ...
    if msgs > max_msg then
      ...
      if gbanspamonredis then
        if tonumber(gbanspamonredis) ==  2 and not is_owner(msg) then
          ...
          send_large_msg("chat#id"..msg.to.id, "\n»User Has Been Super Ban!\n->Info User: \n》Name:"..name.." \n》UserName: "..(username or 'User Not Set!').."\n》ID:"..msg.from.id.." \n》Link: \nhttps://telegram.me/"..(username or 'Knight_team').."\n»Frome This Gp:\n"..msg.to.print_name.." \n")
